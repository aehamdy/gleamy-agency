...
function LandingPage() {
  ...
  return (
    <section className="relative flex flex-col gap-8 text-start mt-[25%] md:mt-[5%]">
      ...
      <MarqueeBar variant="text-white bg-[#212121] rotate-[-13deg] md:rotate-[-21deg] lg:rotate-[-15deg]" position="bottom-[12rem] md:bottom-[20rem] lg:bottom-[18rem] -start-[8rem] md:-start-[18rem]" />
    </section>
)
}
