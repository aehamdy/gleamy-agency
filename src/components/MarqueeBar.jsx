...
function MarqueeBar({ variant, position}) {
  ...
  return (
    ...
    <div className={`wrapper absolute py-3 text-3xl uppercase tracking-wider font-roboto text-center ${position} z-0 pointer-events-none`}>
      <div className={`marquee-text overflow-clip  ${variant}`}>
        ...
        <p className="relative py-4 px-5 before:absolute before:w-2.5 before:h-2.5 before:bg-accent before:rounded-full before:top-1/2 before:-translate-y-1/2 before:-start-3">creative design</p>
        ...
        <p className="relative py-4 px-5 before:absolute before:w-2.5 before:h-2.5 before:bg-accent before:rounded-full before:top-1/2 before:-translate-y-1/2 before:-start-3">creative design</p>
        <p aria-hidden="true" className="relative py-4 px-5 before:absolute before:w-2.5 before:h-2.5 before:bg-accent before:rounded-full before:top-1/2 before:-translate-y-1/2 before:-start-3">creative design</p>
