  ...
  return (
    ...
    <div className="wrapper">
      <div className="marquee-text">
        ...
        <p>branding</p>
        <p>animation</p>
        <p aria-hidden="true">creative design</p>
        <p aria-hidden="true">ui/ux</p>
        <p aria-hidden="true">marketing</p>
        <p aria-hidden="true">motion</p>
        <p aria-hidden="true">branding</p>
        <p aria-hidden="true">animation</p>
        </div>
      </div>
    </div>
  );
